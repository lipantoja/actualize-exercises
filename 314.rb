...
puts "Give me a word"
word = gets.chomp
# Maybe throw the string into an array
word = word.split (//)
pp word

# Take the first letter of the string in the array

# PUsh the first letter or 0 placement of the string/array to the end of the word or string
