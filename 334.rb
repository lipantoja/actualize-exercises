...
# which word was entered the most frequently. 
    #(Going to need a .count here ->> count will count how many instantces an object is found in an array)
...
# potentially use a .times

# throw the items within an array by using a hash